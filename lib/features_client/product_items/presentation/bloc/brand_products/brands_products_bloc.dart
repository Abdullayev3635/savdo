...
class BrandsProductsBloc
  ...
  List<ClientBrandProductModel> brandProductList = [];
  ...
  FutureOr<void> getBrandProduct(
    ...
    var rList = <ClientBrandProductModel>[];
    var oldPerson = <ClientBrandProductModel>[];
    var currentList = <ClientBrandProductModel>[];
