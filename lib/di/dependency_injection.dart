...
import '../features/buyurtma/data/model/branch_model.dart';
...
import '../features/product_items/domain/usescase/change_product.dart';
...
Future<void> init() async {
  ...
  di.registerFactory(
    () => BrandsProductsBloc(brandProducts: di(), sendChangedProduct: di()),
  );
  ...
  di.registerLazySingleton(() => SendChangedProduct(brandProducRepository: di()));
