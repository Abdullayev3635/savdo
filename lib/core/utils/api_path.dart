...
String baseUrlImage = "http://ncollective.uz/api/";
...
const String wholeOrderPHP = "wholesale-shop";
const String wholeOrderAgentPHP = "order/create";
...
const String restore = "products/8/restore";
