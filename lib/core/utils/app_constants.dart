...
const String branchBox = 'branch_box';
...
const String sharedBuyurtmaBranchId = 'b_branch_id';
const String sharedSalesAgentId = 'worker_id';
const String sharedIsAgent = 'isAgent';
const String sharedisDostavshik = 'isDostavshik';
