...
class SelectRegion extends StatefulWidget {
  ...
  static Widget screen() => BlocProvider(
        create: (context) => di<RegionBloc>()..add(GetSelectRegionLocalEvent()),
...
class _SelectRegionState extends State<SelectRegion> {
  late RegionBloc _bloc;

  TextEditingController searchController = TextEditingController();

  @override
  void initState() {
    _bloc = BlocProvider.of<RegionBloc>(context);
    _bloc.add(GetSelectRegionEvent());
    super.initState();
  }
      ...
      child: Container(
        ...
        child: BlocBuilder<RegionBloc, RegionState>(
          builder: (context, state) {
            if (state is SelectRegionSuccess) {
              return Column(
                ...
                children: [
                  ...
                  TextField(
                      ...
                      onChanged: (text) {
                        _bloc.add(
                            FilterRegionEvent(text: text, list: state.list));
                      }),
                  Expanded(
            ...
            } else if (state is SelectRegionLoading) {
              return SizedBox(
