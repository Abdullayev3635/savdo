...
import '../../../price_change/pages/price_change.dart';
            ...
            ProfileItemsWidgets(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => PriceChangePage.screen(
                      brandName: "Tovarlar narxini o'zgartirish",
                      salesAgentId: int.parse(sharedPreferences.getString(sharedSalesAgentId) ?? '0',),
                      brandId: null,
                      priceTypeId: int.parse(sharedPreferences.getString(sharedPriceTypeId) ?? '0',),
                    ),
                  ),
                );
              },
              icon: 'assets/icons/shopping-cart_inactive.svg',
              title: 'Mahsulot narxlarini o`zgartirish',
            ),
            ProfileItemsWidgets(
              onTap: () {
