...
class KorzinaBloc extends Bloc<KorzinaEvent, KorzinaState> {
  ...
  KorzinaBloc({required this.usesBuyurtma}) : super(KorzinaInitial()) {
    on<KorzinaInitialEvent>(getBuyurtma, transformer: sequential());
  }
  ...
  FutureOr<void> getBuyurtma(
    ...
    result.fold(
          ...
          if (failure is NoConnectionFailure)
            ...
            (r) => {emit(KorzinaSuccessState(buyurtmaList: r))});
  }
}
