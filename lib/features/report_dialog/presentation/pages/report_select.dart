          ...
          child: Column(
            children: [
              RadioListTile<String>(
                ...
                value: "1",
                title:
                    Text("Ulgurji Savdo reestri", style: textStylePrimaryMed16),
              ...
              sharedPreferences.getBool(sharedIsAgent) == true
                  ...
                  : RadioListTile<String>(
                      ...
                      value: "2",
                      title:
                          Text("Mahsulot kirimi", style: textStylePrimaryMed16),
                      groupValue: selectedValue,
                      onChanged: (value) => setState(
                        () {
                          selectedValue = value.toString();
              ...
              sharedPreferences.getBool(sharedIsAgent) == true
                  ...
                  : RadioListTile<String>(
                      ...
                      value: "5",
                      title:
                          Text("Kassa qoldigi", style: textStylePrimaryMed16),
                      groupValue: selectedValue,
                      onChanged: (value) => setState(
                        () {
                          selectedValue = value.toString();
              ...
              RadioListTile<String>(
                activeColor: primaryColor,
                value: "6",
                title: Text("Mijoz DT-KT qoldiqlari",
                    style: textStylePrimaryMed16),
                groupValue: selectedValue,
                onChanged: (value) => setState(
                  () {
              ...
              RadioListTile<String>(
                activeColor: primaryColor,
                value: "7",
                title: Text("Mijoz bilan akt sverka",
                    style: textStylePrimaryMed16),
                groupValue: selectedValue,
                onChanged: (value) => setState(
                  () {
