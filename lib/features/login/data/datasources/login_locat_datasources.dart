...
class LoginLocalDataSourceImpl implements LoginLocalDataSource {
  ...
  Future<String> setDataLocal(UserModel list) async {
    try {
      ...
      sharedPreferences.setString(sharedBuyurtmaBranchId, list.branchId.toString());
      sharedPreferences.setString("branch_name", list.branchName.toString());
      sharedPreferences.setString("roles", list.roles.toString());
      sharedPreferences.setBool("isAgent", list.isAgent);
      sharedPreferences.setBool("isDostavshik", list.isDostavshik);
      sharedPreferences.setString("roles", list.roles.toString());
